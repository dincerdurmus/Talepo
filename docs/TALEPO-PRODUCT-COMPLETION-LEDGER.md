...
| LG-98j | Part IV rol ayrımı: ürün kanalı yalnız ÜRÜN-sınıfı özneden dolar | FIXED (3256955) | publish köprüsünde productBearingKind kapısı (I51b, "pompa" sızıntısı); edat-nesnesi kuralı ("Klima arıyorum salon için" → klima); için-guard fiil-öncesi pencereye daraltıldı (mach-08 geri kazanıldı); mfg adı kullanıcının TAM öbeğini taşır ("Karton kutu") |
| LG-98k | Ürün-türü zarf tabanı 98→83 (sayılı rebase) | REBASED | 10 satır DEĞER İYİLEŞTİ (parça/servis adı → ebeveyn/nesne ürün türü: baby-08 bebek arabası, mach-05 Torna tezgahı, svc-08 Kombi…), 15 satır DÜRÜST BOŞ (rol sızıntısı temizlendi, ebeveyn çözülmedi). Presence yüzeyi 88→62; part bilgisi attributes kanalında yaşıyor. Kalite karşılığı: quality ③ %100 |
| LG-98l | Part IV 2. dalga: konumsal eksen kuralları | FIXED (1951373) | (a) çıplak "almak istiyorum" araç kanıtı değil (catering→VEHICLE çöküşü); (b) boşluklu lastik ebadı TIRE_SIZE span (geometri aralıklı; "r16"/"315" model olamaz); (c) fiil-sonrası çıplak servis adı kuyruk spekidir — tek yetkili serviceNounIsPostVerbAuxiliary, 4 tüketici ("akvaryum arıyorum … kurulum" %86 SERVICE çöküşü kapandı); (d) ettirgen ince-ünlü mastar (-tirmek) + YÜKSEK-ünlülü iyelik soyma ("paketleme" ispatla güvende) |
| LG-98m | Part IV taze probe turu (41 doğal girdi) | MEASURED | 4 gerçek sınıf bulundu ve kapatıldı (LG-98l); kozmetik kalıntılar dürüstçe açık: "kafeme" ad başında (bilinçli dar desen), "traktör lastiği" compose cümlesi "Traktör arıyorum." (zarf ürünü doğru), soru-formu girdiler ("var mı", "hangisi") kategori onayına düşer |
