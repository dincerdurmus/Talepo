...
export const ENV_CATALOG: EnvVarSpec[] = [
  ...
  {
    name: "TALEPO_IYZICO_API_KEY",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "iyzico API key (server-only). Alias: IYZICO_API_KEY.",
  },
  {
    name: "TALEPO_IYZICO_SECRET_KEY",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "iyzico secret key (server-only). Alias: IYZICO_SECRET_KEY.",
  },
  {
    name: "TALEPO_IYZICO_MERCHANT_ID",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "iyzico merchant id (MID) — required for subscription webhook V3.",
  },
  {
    name: "TALEPO_IYZICO_ENVIRONMENT",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "sandbox | production — do not infer payment env from NODE_ENV alone.",
  },
  {
    name: "TALEPO_IYZICO_BASE_URL",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "Override iyzico API base URL.",
  },
  {
    name: "TALEPO_IYZICO_PLAN_PREMIUM_MONTHLY",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "iyzico pricingPlanReferenceCode for PREMIUM monthly.",
  },
  {
    name: "TALEPO_IYZICO_PLAN_PROFESSIONAL_MONTHLY",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "iyzico pricingPlanReferenceCode for PROFESSIONAL monthly.",
  },
  {
    name: "TALEPO_IYZICO_PLAN_CORPORATE_MONTHLY",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "iyzico pricingPlanReferenceCode for CORPORATE monthly.",
  },
  {
    name: "TALEPO_BILLING_CALLBACK_BASE_URL",
    classification: "OPTIONAL",
    serverOnly: true,
    description: "Public HTTPS base for billing callback/webhook URLs.",
  },
  {
