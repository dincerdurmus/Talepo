...
export const PRO_FEATURE_PRESENTATION: Partial<Record<FeatureKey | "follow_up_intelligence" | "opportunity_intelligence", FeaturePresentation>> = {
  ...
  basic_market_insights: { label: "Price Intelligence", description: "Fiyat bandını ve teklif pozisyonunu anlamana yardımcı olur.", howItWorks: "Mevcut fiyat sinyallerini piyasa bağlamında gösterir.", resultLocation: "Fiyat analizi", interactionType: "INFORMATIONAL", status: "LIVE", contexts: ["PERSONAL", "WORKSPACE"] },
