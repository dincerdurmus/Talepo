...
export function ExploreFilterUpsell() {
  return (
    <div className="mt-3 flex flex-col gap-3 rounded-xl border border-sky-200/70 bg-gradient-to-br from-[#eef8ff] to-[#e0f0ff] p-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-start gap-2.5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-xs leading-5 text-[#1e40af]/70">
            Kategori alanları, bütçe aralığı, acil talep ve tarih filtreleri için
            planınızı yükseltin.
          </p>
        </div>
      </div>
