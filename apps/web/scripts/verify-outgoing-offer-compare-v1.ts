...
console.log("\n=== SURFACE ===\n");
{
  ...
  check("offer eyebrow Teklifiniz", card.includes("Teklifiniz"));
  check("status Sıra sizde", card.includes("Sıra sizde"));
  check("status Yanıt bekleniyor", card.includes("Yanıt bekleniyor"));
  check("status Gönderildi", card.includes("Gönderildi"));
  ...
  check("deep link highlight", group.includes("OfferDeepLinkTarget") && page.includes("teklif"));
  ...
  check("buyer page preserved Gelen teklif", buyerPage.includes("IncomingOfferCompareGroup"));
}
...
console.log("\n=== COMPARE ===\n");
{
  ...
  check("card uses negotiation compare", card.includes("compareNegotiationPrices"));
  check("card uses budget compare for first offer", card.includes("compareBuyerBudgetToOffer"));
}

console.log("\n=== ACTIONS / COPY ===\n");
{
  check("accept label teklifini kabul et", card.includes("teklifini kabul et"));
  check("seller reject Teklifi reddet", card.includes('rejectLabel: "Teklifi reddet"'));
