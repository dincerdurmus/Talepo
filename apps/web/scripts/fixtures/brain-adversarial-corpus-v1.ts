...
const BASES: BaseTemplate[] = [
  // AUTOMOTIVE
  { id: "auto-a", input: "Volkswagen Passat 2020 model arıyorum", allowBudgetSuffix: true, expected: { categories: ["automotive"], kinds: ["VEHICLE"], brand: "volkswagen", model: "passat", forbiddenNumbers: [2020], answeredKeys: ["brand", "model", "modelYear"] } },
  ...
  { id: "auto-d", input: "Araba lastiği arıyorum 205/55 R16", expected: { categories: ["automotive"], kinds: ["PRODUCT", "PART"], forbiddenNumbers: [205, 55, 16] } },
  ...
  // TECHNOLOGY
  { id: "tech-a", input: "iPhone 15 Pro Max arıyorum", allowBudgetSuffix: true, expected: { categories: ["technology"], kinds: ["PRODUCT"], brand: "apple", model: "iphone 15", answeredKeys: ["brand"] } },
  { id: "tech-b", input: "Oyun bilgisayarı arıyorum 32 GB RAM olsun", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["technology"], kinds: ["PRODUCT"], forbiddenNumbers: [32] } },
  { id: "tech-c", input: "Muhasebe yazılımı lisansı arıyorum", expected: { categories: ["technology"], kinds: ["PRODUCT"] } },
  { id: "tech-d", input: "Samsung televizyon arıyorum 55 inç", expected: { categories: ["technology"], kinds: ["PRODUCT"], brand: "samsung", forbiddenNumbers: [55], answeredKeys: ["brand", "screenSize"] } },
  { id: "tech-e", input: "Sunucu bakım hizmeti arıyorum", expected: { categories: ["technology"], kinds: ["SERVICE"] } },
  { id: "tech-f", input: "Laptop lazım acil", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["technology"], kinds: ["PRODUCT"] } },
  ...
  // APPLIANCES
  { id: "appl-a", input: "Çamaşır makinesi arıyorum 9 kg", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["appliances"], kinds: ["PRODUCT"], forbiddenNumbers: [9], answeredKeys: ["capacity"] } },
  { id: "appl-b", input: "Arçelik bulaşık makinesi bakıyorum", allowBudgetSuffix: true, expected: { categories: ["appliances"], kinds: ["PRODUCT"], brand: "arcelik", answeredKeys: ["brand"] } },
  { id: "appl-c", input: "İnverter klima arıyorum 12000 BTU", expected: { categories: ["appliances"], kinds: ["PRODUCT"], forbiddenNumbers: [12000] } },
  { id: "appl-d", input: "Buzdolabı arıyorum, no-frost olsun", allowAnyBrand: true, expected: { categories: ["appliances"], kinds: ["PRODUCT"] } },
  { id: "appl-e", input: "Bosch ankastre fırın arıyorum", expected: { categories: ["appliances"], kinds: ["PRODUCT"], brand: "bosch", answeredKeys: ["brand"] } },
  { id: "appl-f", input: "Klima için dış ünite fan motoru arıyorum", expected: { categories: ["automotive", "appliances"], kinds: ["PART"] } },
  { id: "appl-g", input: "Dikey süpürge arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["appliances"], kinds: ["PRODUCT"] } },
  // FURNITURE
  { id: "furn-a", input: "Yemek masası arıyorum 6 kişilik ahşap", expected: { categories: ["furniture"], kinds: ["PRODUCT"], forbiddenNumbers: [6], answeredKeys: ["material"] } },
  { id: "furn-b", input: "Ergonomik ofis koltuğu arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["furniture"], kinds: ["PRODUCT"] } },
  { id: "furn-c", input: "Koltuk takımı arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["furniture"], kinds: ["PRODUCT"] } },
  ...
  { id: "furn-e", input: "Sandalye arıyorum 4 adet", expected: { categories: ["furniture"], kinds: ["PRODUCT"], quantity: { value: 4, unit: "adet" }, answeredKeys: ["quantity"] } },
  // HOME-KITCHEN
  ...
  { id: "home-b", input: "Tabak takımı arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["home-kitchen"], kinds: ["PRODUCT"] } },
  { id: "home-c", input: "6 kişilik kahve fincanı seti arıyorum", expected: { categories: ["home-kitchen"], kinds: ["PRODUCT"], forbiddenNumbers: [6] } },
  { id: "home-d", input: "Çaydanlık arıyorum", allowAnyBrand: true, expected: { categories: ["home-kitchen", "appliances"], kinds: ["PRODUCT"] } },
  // BABY
  { id: "baby-a", input: "Bebek arabası arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["baby"], kinds: ["PRODUCT"] } },
  { id: "baby-b", input: "Bebek arabası için tekerlek arıyorum", expected: { categories: ["baby"], kinds: ["PART"] } },
  { id: "baby-c", input: "Mama sandalyesi arıyorum", allowAnyBrand: true, expected: { categories: ["baby"], kinds: ["PRODUCT"] } },
  { id: "baby-d", input: "Bebek bezi arıyorum 4 numara", expected: { categories: ["baby"], kinds: ["PRODUCT"], forbiddenNumbers: [4] } },
  // HEALTH
  { id: "hlth-a", input: "Tansiyon aleti arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["health"], kinds: ["PRODUCT", "MEDICAL_DEVICE"] } },
  { id: "hlth-b", input: "Tekerlekli sandalye arıyorum", allowAnyBrand: true, expected: { categories: ["health"], kinds: ["PRODUCT", "MEDICAL_DEVICE"] } },
  { id: "hlth-c", input: "Hasta yatağı kiralamak istiyorum", expected: { categories: ["health"], kinds: ["PRODUCT", "MEDICAL_DEVICE"] } },
  ...
  // REAL-ESTATE
  { id: "re-a", input: "Kiralık daire arıyorum 2+1", expected: { categories: ["real-estate"], kinds: ["REAL_ESTATE", "PROPERTY"], forbiddenNumbers: [2, 1, 3], answeredKeys: ["roomCount", "listingType"] } },
  { id: "re-b", input: "Satılık arsa arıyorum", allowBudgetSuffix: true, expected: { categories: ["real-estate"], kinds: ["REAL_ESTATE", "PROPERTY"], answeredKeys: ["listingType"] } },
  { id: "re-c", input: "3+1 daire arıyorum Kadıköy", expected: { categories: ["real-estate"], kinds: ["REAL_ESTATE", "PROPERTY"], forbiddenNumbers: [3, 1, 4], answeredKeys: ["roomCount"] } },
  { id: "re-d", input: "Ofis kiralamak istiyorum", expected: { categories: ["real-estate"], kinds: ["REAL_ESTATE", "PROPERTY"], answeredKeys: ["listingType"] } },
  // SERVICES
  ...
  // MACHINERY
  { id: "mach-a", input: "CNC tezgahı arıyorum", allowBudgetSuffix: true, expected: { categories: ["machinery"], kinds: ["INDUSTRIAL_EQUIPMENT", "PRODUCT"] } },
  ...
  { id: "mach-d", input: "Paketleme makinesi arıyorum", allowBudgetSuffix: true, expected: { categories: ["machinery"], kinds: ["INDUSTRIAL_EQUIPMENT", "PRODUCT"] } },
  { id: "mach-e", input: "500 litre kompresör arıyorum", expected: { categories: ["machinery"], kinds: ["INDUSTRIAL_EQUIPMENT", "PRODUCT"], forbiddenNumbers: [500] } },
  ...
  { id: "tech-i", input: "PlayStation 5 arıyorum", allowBudgetSuffix: true, expected: { categories: ["technology"], kinds: ["PRODUCT"], brand: "sony", model: "playstation" } },
  { id: "tech-j", input: "Kablosuz kulaklık arıyorum", allowAnyBrand: true, allowBudgetSuffix: true, expected: { categories: ["technology"], kinds: ["PRODUCT"] } },
  ...
  { id: "appl-h", input: "Solo kahve makinesi arıyorum", allowBudgetSuffix: true, expected: { categories: ["appliances"], kinds: ["PRODUCT"] } },
  { id: "home-e", input: "Granit tava seti arıyorum", allowAnyBrand: true, expected: { categories: ["home-kitchen"], kinds: ["PRODUCT"] } },
  { id: "home-f", input: "Cam saklama kabı arıyorum 10 adet", expected: { categories: ["home-kitchen"], kinds: ["PRODUCT"], quantity: { value: 10, unit: "adet" }, answeredKeys: ["quantity"] } },
  { id: "furn-f", input: "Beyaz gardırop arıyorum 2 kapaklı", expected: { categories: ["furniture"], kinds: ["PRODUCT"], forbiddenNumbers: [2] } },
  { id: "hlth-f", input: "İşitme cihazı arıyorum", allowAnyBrand: true, expected: { categories: ["health"], kinds: ["PRODUCT", "MEDICAL_DEVICE"] } },
  ...
  { id: "mach-f", input: "Ekskavatör kiralamak istiyorum", allowBudgetSuffix: true, expected: { categories: ["machinery"], kinds: ["INDUSTRIAL_EQUIPMENT", "PRODUCT"] } },
  { id: "prnt-e", input: "Düğün davetiyesi bastırmak istiyorum 200 adet", expected: { categories: ["printing"], kinds: ["MANUFACTURED_ITEM"], quantity: { value: 200, unit: "adet" }, answeredKeys: ["quantity"] } },
  // PRINTING
  { id: "prnt-a", input: "1000 adet kartvizit bastırmak istiyorum", expected: { categories: ["printing"], kinds: ["MANUFACTURED_ITEM"], quantity: { value: 1000, unit: "adet" }, answeredKeys: ["quantity"] } },
  { id: "prnt-b", input: "Broşür bastırmak istiyorum", expected: { categories: ["printing"], kinds: ["MANUFACTURED_ITEM"] } },
  { id: "prnt-c", input: "50 bin adet karton kutu ürettirmek istiyorum", expected: { categories: ["printing"], kinds: ["MANUFACTURED_ITEM"], quantity: { value: 50000, unit: "adet" }, answeredKeys: ["quantity"] } },
